...
import { 
  BarChart2, X, MessageSquare, ThumbsUp, Heart, 
...
export default function InsightsPanel({ isOpen, onClose }) {
  ...
  return (
    <div className="modal-overlay insights-overlay" role="dialog" aria-modal="true" aria-labelledby="insights-title">
      <div className="modal-container insights-modal" ref={modalRef}>
        
        {/* Header */}
        <div className="modal-header">
          <div className="modal-title" id="insights-title">
            <BarChart2 size={20} className="insights-header-icon" />
        ...
        {/* Body */}
        <div className="modal-body insights-body">
          {isEmpty ? (
